...
const TestimonialsSection = () => {
  const testimonialsWhatsAppLink = generateWhatsAppLink(
    "Hola! Vi los testimonios y quiero cotizar mi evento"
  );
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center">
          ...
          <Button
            ...
            asChild
          >
            <a href={testimonialsWhatsAppLink} target="_blank" rel="noopener noreferrer">

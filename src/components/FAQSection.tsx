...
const FAQSection = () => {
  const faqWhatsAppLink = generateWhatsAppLink(
    "Hola! Tengo una consulta sobre catering para mi evento"
  );
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center">
          ...
          <Button
            ...
            asChild
          >
            <a href={faqWhatsAppLink} target="_blank" rel="noopener noreferrer">

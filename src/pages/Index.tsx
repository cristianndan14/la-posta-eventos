...
const Index = () => {
  ...
  return (
    <main>
      ...
      <a
        href="https://wa.me/5491121639741"
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Contactanos por WhatsApp"
        className="fixed bottom-6 right-6 z-50 bg-[#25D366] hover:bg-[#1ebe5d] text-white p-4 rounded-full shadow-lg hover:scale-110 transition-transform"
      >

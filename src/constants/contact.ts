...
export const COVERAGE_ZONES = [
  ...
  {
    id: "gran_buenos_aires_norte",
    name: "Gran Buenos Aires Norte",
    displayName: "Zona Norte (Gran Buenos Aires)",
    municipalities: [
      "San Isidro",
      "Tigre",
      "San Martín",
    ...
    description: "Cobertura en la zona norte del Gran Buenos Aires",
  ...
  {
    id: "gran_buenos_aires_oeste",
    name: "Gran Buenos Aires Oeste",
    displayName: "Zona Oeste (Gran Buenos Aires)",
    municipalities: [
      "MoróN",
      "Ituzaingó",
      "Merlo",
    ...
    description: "Cobertura en la zona oeste del Gran Buenos Aires",
    delivery_time: "48-72 horas",
    surcharge: 10,
  },
  {
    ...
    description: "Servicio disponible en ciudades principales con consulta previa",
    delivery_time: "Según ubicación",
    surcharge: 25,
  },
] as const;
